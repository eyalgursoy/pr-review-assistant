...
```bash
# Install in Cursor
cursor --install-extension pr-review-assistant-0.15.9.vsix

# Or in VS Code
code --install-extension pr-review-assistant-0.15.9.vsix
```

Replace `0.15.9` with the version you downloaded if different.
