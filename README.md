...
```bash
# Install in Cursor
cursor --install-extension pr-review-assistant-0.15.10.vsix

# Or in VS Code
code --install-extension pr-review-assistant-0.15.10.vsix
```

Replace `0.15.10` with the version you downloaded if different.
