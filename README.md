...
```bash
# Install in Cursor
cursor --install-extension pr-review-assistant-0.16.1.vsix

# Or in VS Code
code --install-extension pr-review-assistant-0.16.1.vsix
```

Replace `0.16.1` with the version you downloaded if different.
