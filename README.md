...
```bash
# Install in Cursor
cursor --install-extension pr-review-assistant-0.15.8.vsix

# Or in VS Code
code --install-extension pr-review-assistant-0.15.8.vsix
```

Replace `0.15.8` with the version you downloaded if different.
