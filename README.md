...
```bash
# Install in Cursor
cursor --install-extension pr-review-assistant-0.18.3.vsix

# Or in VS Code
code --install-extension pr-review-assistant-0.18.3.vsix
```

Replace `0.18.3` with the version you downloaded if different.
