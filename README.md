...
```bash
# Install in Cursor
cursor --install-extension pr-review-assistant-0.15.7.vsix

# Or in VS Code
code --install-extension pr-review-assistant-0.15.7.vsix
```

Replace `0.15.7` with the version you downloaded if different.
