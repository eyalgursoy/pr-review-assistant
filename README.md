...
```bash
# Install in Cursor
cursor --install-extension pr-review-assistant-0.15.13.vsix

# Or in VS Code
code --install-extension pr-review-assistant-0.15.13.vsix
```

Replace `0.15.13` with the version you downloaded if different.
